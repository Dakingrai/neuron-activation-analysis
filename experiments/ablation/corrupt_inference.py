...
class CorruptSingle:
    def __init__(self, 
        ...
        def hook(module, input, output):
            ...
            module.weight.data[:, neuron] = torch.from_numpy(prng.normal(-1, 1, module.weight.data[:, neuron].shape[0])).to(module.weight.data.device)
